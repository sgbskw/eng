<aside class="w-72 bg-gray-900 text-white flex flex-col h-full overflow-y-auto" dir="rtl">
    ...
    <nav class="p-6 space-y-4 flex-1">
        <a href="{{ route('dashboard') }}" class="flex items-center gap-4 p-4 rounded-2xl hover:bg-gray-800 transition">
        ...
        <a href="{{ route('projects.create') }}" class="flex items-center gap-4 p-4 rounded-2xl bg-blue-600 shadow-lg shadow-blue-900/20">
